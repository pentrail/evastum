        ...
        child: ListView(
          children: [
            ...
            child: Column(
              children: [
                const Padding(
                  padding: EdgeInsets.only(top: 25.0, left: 10, bottom: 15, right: 10),
                  child: Text(
                  ...
                  child: Stack(
                    ...
                    TextFormField(
                        ...
                        decoration: InputDecoration(
                          errorMaxLines: 2,
                          errorStyle: TextStyle(color: Colors.white70, fontSize: 14),
                          errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15),
                            borderSide: BorderSide(color: Colors.white30.withOpacity(0.5), width: 2),),
              ...
              Padding(
                padding: const EdgeInsets.only(top: 30.0, left: 10, bottom: 15, right: 10),
                child: Text(
